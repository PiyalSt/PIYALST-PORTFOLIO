    ...
    <>
      <div className=''>
        ...
        <div className='leading-16 mt-4 mb-2'>
            <h2 className='font-inter font-bold text-5xl md:text-[4vw] text-text'>{title1}<span className='text-accent'>{title2}</span></h2>
            <span className='font-inter font-bold text-4xl md:text-[4vw] text-accent2'>{title3}</span>
        </div>
